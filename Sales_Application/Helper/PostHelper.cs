   ...
   ShipperDto shipper)
        {
            ...
            {
                var serializer = JsonSerializer.Create(new JsonSerializerSettings());//serializer heavy weight file to a lighy weight.
        ...
        public static async Task PublishToEventGrid(IConfiguration config, ShipperDto shipper)
        {
